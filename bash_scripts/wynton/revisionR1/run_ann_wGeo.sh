...
#$ -N ANN_dlt #!!!
#### Output file
#$ -o wynton/revisonR1/logs/$JOB_NAME_$JOB_ID.out
#### Error file
#$ -e wynton/revisionR1/logs/$JOB_NAME_$JOB_ID.err
#### memory per core
#$ -l mem_free=4G
#### number of cores 
#$ -pe smp 40
...
singularity exec ~/MyResearch/sgm_mne_lib_fc.sif python -u ../python_scripts/revisionR1/RUN_ANN_WANN_wGeo.py  --noise_sd 1.2 --num_prior_sps 1000 --num_round 3 --nepoch 100 --band delta #!!!
