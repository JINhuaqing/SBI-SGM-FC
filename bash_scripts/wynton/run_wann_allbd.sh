...
singularity exec ~/MyResearch/sgm_mne_lib_fc.sif python -u ../python_scripts/M5_RUN_ALLBD_WANN.py --noise_sd 1.2 --num_prior_sps 1000 --num_round 3 --nepoch 100 --include_beta #!!!
