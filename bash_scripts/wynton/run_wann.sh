...
singularity exec ~/MyResearch/sgm_mne_lib_fc.sif python -u ../python_scripts/M3_RUN_BW_WANN.py --noise_sd 1.2 --num_prior_sps 1000 --num_round 3 --nepoch 100 --band delta #!!!
